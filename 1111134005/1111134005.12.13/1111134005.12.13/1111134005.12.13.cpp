// 1111134011.12.13.cpp : 此檔案包含 'main' 函式。程式會於該處開始執行及結束執行。
//
...
{
    // initialize a
    int a[SIZE][4] = { {1,70,77,0},{2,88,90,0},{3,58,85,0},
        {4,78,98,0},{5,85,80,0},{6,75,72,0},{7,98,88,0},
        {8,54,88,0},{9,56,82,0},{10,56,61,0} };//二維陣列
