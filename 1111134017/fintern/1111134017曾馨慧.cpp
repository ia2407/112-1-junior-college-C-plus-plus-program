...
{
    struct student std1;
    struct student std2 = { 2,"Danny","Jerry","Tom","Sue","Mary","John","Mark","Nina","Apple","Juice"};
    std1.id = 1;
    strcpy(std1.name, "Danny", "Jerry", "Tom", "Sue", "Mary", "John", "Mark", "Nina", "Apple", "Juice");
    std1.score = { 1,74,55,0 }, { 2,56,88,0 }, { 3,84,11,0 },
    { 4,88,52,0 }, { 5,100,100,0 }, { 6,0,0,0 }, { 7,51,81,0 }, { 8,74,14,0 },
    { 9,77,55,0 }, { 10,97,68,0 }
    return 0;
}