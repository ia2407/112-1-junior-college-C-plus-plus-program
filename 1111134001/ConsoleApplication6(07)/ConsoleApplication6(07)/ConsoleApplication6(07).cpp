// ConsoleApplication6(07).cpp : 此檔案包含 'main' 函式。程式會於該處開始執行及結束執行。
//
...
#include <stdio.h>
#define RESPONSES_SIZE 40//調查數
#define FREQUENCY_SIZE 11//評分
void freq(int frequency[FREQUENCY_SIZE]);//副程式原型宣告

int main(void)
{
    int frequency[FREQUENCY_SIZE] = { 0 };//將陣列的11個值都初始化為0
